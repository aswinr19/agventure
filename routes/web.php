...
Route::get('/auctions/{id}', [AuctionController::class, 'displayOne'])->middleware('isLoggedIn');
...
Route::get('farmer/auction/results/{id}', [AuctionController::class, 'result'])->middleware('isFarmer');

Route::get('farmer/auction/results/approve/{id}', [AuctionController::class, 'approveBid'])->middleware('isFarmer');
